...
- **窗口最小尺寸提高** — 主窗口最小尺寸从 900×600 提高到 900×900,矮窗口不再挤压监控区与聊天布局。
...
- **Larger minimum window** — the main window's minimum size rises from 900×600 to 900×900, so short windows no longer squeeze the monitor and chat layouts.
