...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'models.importDir': '引入目录',
    'models.dirNotSet': '未设置',
    'models.chooseDir': '选择文件夹',
    'models.chooseDirTitle': '选择模型引入目录',
    'models.sourceDownload': '下载目录',
    'models.sourceImport': '引入目录',
    ...
    'settings.directoriesHint': '下载路径决定新内容的落点；复用已有文件的引入目录仍在主页与模型管理页设置。',
  ...
  en: {
    ...
    'models.importDir': 'Import Directory',
    'models.dirNotSet': 'Not set',
    'models.chooseDir': 'Choose Folder',
    'models.chooseDirTitle': 'Select the model import directory',
    'models.sourceDownload': 'Download Path',
    'models.sourceImport': 'Imported',
    ...
    'settings.dirDefaultModels': 'LLM-Models',
    'settings.directoriesHint': 'Download paths decide where new content lands; the import directories for reusing existing files stay on the Home and Models pages.',
