...
export const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'settings.directoriesHint': '下载路径决定新内容的落点；复用已有文件的外部路径仍在主页与模型管理页设置。',
  ...
  en: {
    ...
    'settings.dirDefaultModels': 'LLM-Models',
    'settings.directoriesHint': 'Download paths decide where new content lands; external paths for reusing existing files stay on the Home and Models pages.',
