...
export const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    // ─── Libraries & dependencies page (Libraries.vue) ───
    'libraries.title': '库与依赖',
    'libraries.subtitle': '管理服务运行所需的推理引擎与依赖',
    'libraries.errorTitle': '无法获取依赖信息',
    'libraries.retry': '重试',
    'libraries.backendError': '无法连接后端: {msg}',
    'libraries.llamacpp': 'llama.cpp',
    'libraries.llamacpp.status': '状态',
    'libraries.llamacpp.installed': '已安装',
    'libraries.llamacpp.notFound': '未找到',
    'libraries.llamacpp.path': '安装路径',
    'libraries.llamacpp.version': '版本',
    'libraries.downloadDir': '下载路径',
    'libraries.downloadLlamaCpp': '下载 llama.cpp',
    'libraries.custom': '自定义',
    'libraries.customPath': '自定义路径：',
    'libraries.pause': '暂停',
    'libraries.resume': '继续',
    'libraries.stop': '停止',
    'libraries.dlPausedHint': '下载已暂停，点击"继续"恢复',

    // ─── Download status labels (shared: Libraries.vue / TaskDock.vue) ───
    ...
    'settings.directoriesHint': '下载路径决定新内容的落点；复用已有文件的外部路径仍在库与依赖页与模型管理页设置。',
  ...
  en: {
    ...
    // ─── Libraries & dependencies page (Libraries.vue) ───
    'libraries.title': 'Libraries & Dependencies',
    'libraries.subtitle': 'Manage the inference engine and runtime dependencies the service needs',
    'libraries.errorTitle': 'Unable to load dependency info',
    'libraries.retry': 'Retry',
    'libraries.backendError': 'Unable to connect to backend: {msg}',
    'libraries.llamacpp': 'llama.cpp',
    'libraries.llamacpp.status': 'Status',
    'libraries.llamacpp.installed': 'Installed',
    'libraries.llamacpp.notFound': 'Not found',
    'libraries.llamacpp.path': 'Install Path',
    'libraries.llamacpp.version': 'Version',
    'libraries.downloadDir': 'Download Path',
    'libraries.downloadLlamaCpp': 'Download llama.cpp',
    'libraries.custom': 'Custom',
    'libraries.customPath': 'Custom path:',
    'libraries.pause': 'Pause',
    'libraries.resume': 'Resume',
    'libraries.stop': 'Stop',
    'libraries.dlPausedHint': 'Download paused. Click "Resume" to continue',
    ...
    'settings.dirDefaultModels': 'LLM-Models',
    'settings.directoriesHint': 'Download paths decide where new content lands; external paths for reusing existing files stay on the Libraries and Models pages.',
